...
DROP TABLE IF EXISTS `Position`;  /*Do Position là từ khóa trong mysql nên phải dùng `` để*/ 
...
CREATE TABLE JobGroup (
    ...
    CreateDate              DATETIME DEFAULT NOW(),
    FOREIGN KEY (CreatorID) REFERENCES JobAccount(AccountID)
);
...
CREATE TABLE GroupAccount (
    ...
    FOREIGN KEY (GroupID) 	REFERENCES JobGroup(GroupID),
    FOREIGN KEY (AccountID) REFERENCES JobAccount(AccountID)
);
...
CREATE TABLE Question (
    ...
    ContentQuestion         NVARCHAR(200) NOT NULL,
...
CREATE TABLE Answer (
    ...
    ContentAnswer           NVARCHAR(200) NOT NULL,
